...
use App\Http\Controllers\ProductLikeDislikeController;
...
Route::middleware([
    ...
    Route::put('/products/{id}/status-update', [ProductController::class, 'status'])->name('admin.products.status.update');
...
Route::middleware([
	...
	Route::prefix('user')->group(function () {
		...
		Route::post('/plan-like', [ProductLikeDislikeController::class, 'planLikeUpdate'])->name('plan.like.update');
		Route::get('/product', [ProductLikeDislikeController::class, 'product'])->name('product.index');
